...
class ForestBallGame(Game):
    ...
    def __init__(self, game_id: int, database: Database) -> None:
        ...
        self.elements : list[Animal] = [
            ...
            Animals.Lion(odds=(25, 50), probability=4),
            Animals.Tiger(odds=(20, 40), probability=5),
            Animals.Cheetah(odds=(15, 30), probability=8),
            Animals.BrownBear(odds=(10, 20), probability=12),
            Animals.GrayWolf(odds=(5, 10), probability=15),
            Animals.Giraffe(odds=(3, 6), probability=22),
            Animals.WildDog(odds=(2, 5), probability=35),
        ]
    ...
    def settle(self):
        ...
        for player in self.players :
            ...
            elif type(player.status) == Status.Lose or type(player.status) == Status.baozha:
