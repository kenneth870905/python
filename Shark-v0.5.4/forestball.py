...
class ForestBallGame(Game):
    ...
    def __init__(self, game_id: int, database: Database, setting : Settings) -> None:
        ...
        self.elements : list[Animal] = [
            Animals.Panda(odds=(50, 100), probability=2),
            Animals.Lion(odds=(25, 50), probability=2),
            Animals.Tiger(odds=(20, 40), probability=3),
            Animals.Cheetah(odds=(15, 30), probability=5),
            Animals.BrownBear(odds=(10, 20), probability=10),
            Animals.GrayWolf(odds=(5, 10), probability=17),
            Animals.Giraffe(odds=(3, 6), probability=26),
            Animals.WildDog(odds=(2, 5), probability=37),
        ]
        self.odd : Odd = odds_probability(20)
